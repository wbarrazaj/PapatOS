...
printc(style.Dim, sys.argv[1])
printc(style.LightGray, sys.argv[1])
printc(style.Red + style.Underlined, sys.argv[1])
print()
printc(style.BackgroundLightBlue, sys.argv[1])
print(style.LightMagenta + "Hello, " + style.BackgroundRed +"World!")